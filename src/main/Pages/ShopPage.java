...
public class ShopPage extends ApplicationCommon {
    WebDriver driver;

    @FindBy(xpath = "//li[1]/a[. = 'Add to basket']")
    WebElement AddArticleToBascket ;
   ...
   /* @FindBy(xpath = "//a[. = 'Android']")
    ...
    /**
     * Chaque article possède un bouton "ADD TO BASKET" permettant d'ajouter
     * l'article au panier. A chaque ajout, un lien "VIEW BASKET" apparaît au dessous l'article
     */
    public ShopPage AddArticleToBascket(){
    ...
    public ShopPage shopFilterByPrice() {
        ...
        verifierVisibiliteElement(filterButtonSelector1);
    ...
    public BascketPage ModiffromBascket(){

        addToCartSelector.click();
        action.fluentWait(driver,filterButtonSelector,5);
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        wait.until(ExpectedConditions.presenceOfElementLocated(productviewMessage));
        basketiconeSelector.click();
